...
if __name__ == '__main__':
    # sys.path.append(os.path.abspath(os.path.join(os.getcwd(), "/usr/local/bin/python3.6")))  # 当前项目路径加入
    project = '/Users/didi/GitHub/DingtalkChatbot/dingtalkchatbot'

    sys.path.append(project)
    # *************************************这里填写自己钉钉群自定义机器人的token*****************************************
    webhook = 'https://oapi.dingtalk.com/robot/send?access_token=dcea32c9928604299bce4d2ce9ff0f193397cadc6dbb6c81a4eec2795297e7e6'
    # 用户手机号列表，这里填写需要提醒的用户的手机号码，字符串或数字都可以
    at_mobiles = ['17600734210']
    # 初始化机器人小丁
    xiaoding = DingtalkChatbot(webhook)
    # text
    # xiaoding.send_text(msg='我就是小丁，小丁就是我！', is_at_all=True)
    xiaoding.send_text(msg='友情提示：不要忘记上下班打卡！', at_mobiles=at_mobiles)
